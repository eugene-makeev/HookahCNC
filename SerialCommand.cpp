...
SerialCommand::SerialCommand() :
		commandList(NULL), commandCount(0), defaultHandler(NULL), term('\r'), // default terminator for commands, newline character
		last(NULL)
{
...
void SerialCommand::addCommand(const char *command, void (*function)())
{
	...
	commandList = (SerialCommandCallback*) realloc(commandList,
